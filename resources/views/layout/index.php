...
<div class="slider_wrapper">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="carousel-item active">
      <img class="d-block w-100 " src="images/s1.jpg" alt="First slide" height="100%"  width="100%">
    ...
    <div class="carousel-item" role="listbox">
      <img class="d-block w-100 " src="images/s2.jpg" alt="Second slide" height="100%"   width="100%">
         <div class="carousel-caption custom_caption d-none d-md-block">
    <h5></h5>
    <p></p>
  </div>
    ...
    <div class="carousel-item" role="listbox">
      <img class="d-block w-100 " src="images/s3.jpg" alt="Third slide" height="100%"   width="100%">
         <div class="carousel-caption custom_caption d-none d-md-block">
    <h5></h5>
    <p></p>
  </div>
...
<div class="floting_div ">
      ...
      <select id="inputState" class="form-control custom_option ">
       						

        <option selected class="custom_Select">Select your Appointment</option>
        <option>ACO</option>
         <option>OC</option>
          <option>System Admin</option>
           <option>System user</option>
            <option>Desired User</option>
      </select>
    </div>
					...
					<div class="form-group">
						<a href="dashboard_2.html">	<input type="" value="Login" class="btn float-right login_btn"></a>
					</div>
				</form>
			</div>
